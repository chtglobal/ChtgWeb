 ...
 * use the wp-content -deleted.php, blog-inactive.php and
...
function ms_site_check() {
	...
	if ( '1' == $current_blog->deleted ) {
		if ( file_exists( WP_CONTENT_DIR . ' -deleted.php' ) ) {
			return WP_CONTENT_DIR . ' -deleted.php';
		} else {
	...
	if ( '2' == $current_blog->deleted ) {
		if ( file_exists( WP_CONTENT_DIR . ' -inactive.php' ) )
			return WP_CONTENT_DIR . ' -inactive.php';
		else
	...
	if ( $current_blog->archived == '1' || $current_blog->spam == '1' ) {
		if ( file_exists( WP_CONTENT_DIR . ' -suspended.php' ) ) {
			return WP_CONTENT_DIR . ' -suspended.php';
		} else {
			header( 'HTTP/1.1 410 Gone' );
